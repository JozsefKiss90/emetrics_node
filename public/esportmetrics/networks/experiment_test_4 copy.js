...
var instructions_block = {
	...
	pages: [
		...
		'<div class = centerbox><p class = block-text>A feladatod jelezni, hogy a középen lévő nyíl melyik irányba mutat az ennek megefelelő irányú gombok lenyomásával.</p><p style="text-align: center;  font-size: 60px;">&larr; &larr; <span style="color:lightblue">&rarr;</span> &larr; &larr;</p> <img class=center-img src="./images/buttons.png"></img></div>',
		'<div class = centerbox><p class = block-text> A nyilak megjelenése előtt egy csillag <span style="font-size:40px; font-weight: bold;">*</span> tűnhet fel a képernyő egyes pontjain.</p><p class = block-text>A * megjelenésétől függetlenül, próbálj meg mindig a lehető leggyorsabban és legpontosabban válaszolni!</p></div>',
		'<div class = centerbox><p class = block-text>Az instrukciók befejezését követően néhány próba feladat fog következni. A próbák során visszajelzést fogsz kapni a válaszaid helyességéről. <p class = block-text> A kísérlet ezt követő részében már nem fogsz ilyen visszajezést kapni.</p></p></div>',
...
for (b = 0; b < blocks.length; b++) {
	...
	if(b==1) {
		var rest_block = {
			type: 'poldrack-text',
			text: `<div class = centerbox><p style="color:green">33% teljesítve</p><p class = block-text>Most tarts egy rövid szünetet! Nyomj meg egy gombot a folytatáshoz.</p></div>`,
			timing_response: 180000,
			data: {
				trial_id: "rest block"
			},
		...
		var rest_block = {
			type: 'poldrack-text',
			text: `<div class = centerbox><p style="color:green">66% teljesítve</p><p class = block-text>Most tarts egy rövid szünetet! Nyomj meg egy gombot a folytatáshoz.</p></div>`,
			timing_response: 180000,
			data: {
				trial_id: "rest block"
			},
