...
for (l = 0; l < locations.length; l++) {
	...
	for (ci = 0; ci < cues.length; ci++) {
		var c = cues[ci]
		stims = [{
			stimulus: '<div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[7] + '></div></div>',
			data: {
				correct_response: 37,
			...
			stimulus: '<div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[3] + '></div></div>',
			data: {
				correct_response: 37,
				flanker_middle_direction: 'left',
			...
			stimulus: '<div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[4] + '></div></div>',
			data: {
				correct_response: 37,
				flanker_middle_direction: 'left',
			...
			stimulus: '<div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[6] + '></div></div>',
			data: {
				correct_response: 39,
			...
			stimulus: '<div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[2] + '></div></div>',
			data: {
				correct_response: 39,
				flanker_middle_direction: 'right',
				flanker_type: 'congruent',
			...
			stimulus: '<div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[5] + '></div></div>',
			data: {
				correct_response: 39,
				flanker_middle_direction: 'right',
				flanker_type: 'incongruent',
