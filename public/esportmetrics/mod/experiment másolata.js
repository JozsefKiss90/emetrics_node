...
var choices = [37, 39]
var path = 'images/'
var images = [path + 'fix.png', path + 'cue.png', path + 'congright.png', path + 'congleft.png', path + 'incogleft.png', path + 'incogright.png', path + 'neutright.png', path + 'neutleft.png']
//preload
...
for (l = 0; l < locations.length; l++) {
	...
	for (ci = 0; ci < cues.length; ci++) {
		var c = cues[ci]
		stims = [{
			stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div><div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[7] + '></div></div>',
			data: {
				correct_response: 37,
			...
			stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div><div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[3] + '></div></div>',
			data: {
				correct_response: 37,
				flanker_middle_direction: 'left',
			...
			stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div><div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[4] + '></div></div>',
			data: {
				correct_response: 37,
				flanker_middle_direction: 'left',
			...
			stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div><div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[6] + '></div></div>',
			data: {
				correct_response: 39,
			...
			stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div><div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[2] + '></div></div>',
			data: {
				correct_response: 39,
				flanker_middle_direction: 'right',
				flanker_type: 'congruent',
			...
			stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div><div class = centerbox><div class = ANT_' + loc + '><img class = center src =' + images[5] + '></div></div>',
			data: {
				correct_response: 39,
				flanker_middle_direction: 'right',
				flanker_type: 'incongruent',
...
var fixation = {
	...
	stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div>',
	is_html: true,
	choices: 'none',
	data: {
		trial_id: 'fixation'
...
var center_cue = {
	type: 'poldrack-single-stim',
	stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[1] + '></div></div>',
	is_html: true,
	choices: 'none',
	data: {
		trial_id: 'centercue'
...
var double_cue = {
	type: 'poldrack-single-stim',
	stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div><div class = centerbox><div class = ANT_up><img class = center src =' + images[1] + '></div></div><div class = centerbox><div class = ANT_down><img class = center src =' + images[1] + '></div></div>',
	is_html: true,
	choices: 'none',
	data: {
		trial_id: 'doublecue'
...
for (i = 0; i < block.data.length; i++) {
	...
	if (block.data[i].cue == 'nocue') {
		...
		var spatial_cue = {
			type: 'poldrack-single-stim',
			stimulus: '<div class = centerbox><div class = ANT_mid><img class = center src =' + images[0] + '></div></div><div class = centerbox><div class = ANT_' + block.data[i].flanker_location + '><img class = center src =' + images[1] + '></div></div>',
			is_html: true,
			choices: 'none',
			data: {
